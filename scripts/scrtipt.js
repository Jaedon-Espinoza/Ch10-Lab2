...
//Function to display the thrid answer
function ans3() {
    heading.style.display = "block";
...
function ans4() {
    heading.style.display = "block";
    answer.textContent = "We need volunteer to help feed animals, care for animals, and clean animal pens. We also accept donations.";
}